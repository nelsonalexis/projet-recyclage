...
<html>
    <head>
        <title>Comment faire un chouchou</title>
        <meta charset="utf-8">
    ...
    <header>
            <nav class="navbar">
                <div class="content">
                  ...
                  <ul class="menu-list">
                    ...
                    <li><a href="html/Apropos.php">About us</a></li>
                    <li><a href="html/Actualites.php">News</a></li>
                    <li><a href="html/galerie.php">Gallery</a></li>
                    <li><a href="html/blog.php">Blog</a></li>
                    <li><a href="html/contact.php">Contact</a></li>
                    <li><a href="index.php">EN</a><span id="trait">|</span><a href="../FR/index.php">FR</a></li>
                  </ul>
        ...
        <div class="container">
            <div class="contenu">
                <div class="header">
                    <h1> TUTO chouchou</h1>
                    <h3>Vous souhaitez apprendre à faire un chouchou? Vous êtes au bon endroit!</h3><br>
                    <time datetime="2018-07-07"><em>14 mars 2022</em></time><br>
                    <hr>
                </div>

                <div class="texte">
                    <div><video src="../video/Copie de Atelier Sweet Pea.mp4" type="video/mp4" controls></video></div>
                    <br><br><br><br>
                    <p class="auteur"><strong><em>Carla Ascoua</em></strong></p>
                </div>
            </div>
            ...
            <div class="aside">
                <div class="article">
                    ...
                    <div class="link-article">
                        <ol>
                            ...
                            <li><a href="fred_skitty.html">La DJ Fred Skitty</a></li>
                        </ol>
                ...
                <div class="voir">
                    ...
                    <div class="link">
                        <a href="Apropos.php">Le Projet</a>
                        <a href="Actualites.php">Nos Actualités</a>
                        <a href="https://www.instagram.com/atelier_sweetpea/">Follow us on instagram</a>
    ...
    <footer class="footer-distributed">
          ...
          <img src="img/logo.png">
				...
				<p class="footer-links">
					...
					|
					<a href="html/Apropos.php">About us</a>
					|
					<a href="html/Actualites.php">News</a>
					|
					<a href="html/galerie.php">Galery</a>
                    |
				...
				<p class="footer-company-name">Terms of use</p>
			</div>
			...
			<div class="footer-right">
				<p class="footer-company-about">
					...
					We are an eco-friendly fashion project based on Upcycling. Together, let's make the planet a better place</p>
