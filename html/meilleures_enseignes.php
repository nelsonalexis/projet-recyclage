...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="contenu">
                <div class="header">
                    <h1>Les meilleurs enseignes Upcycling</h1>
                    <h3>Si cette grande tendance vous intéresse, alors vous allez adorer ces différentes marques qui font déjà un carton chez les amateurs de l’upcycling. Vous risquez d’être surpris, car les prix ne sont pas forcément très onéreux !</h3><br>
                ...
                <div class="texte">
                    ...
                    <br><br>
                    <div><img src="../img/marine-serre-mytheresa-capsule-0-scaled.jpg"></div>
                    <h2>Marine Serre</h2>
                    <p>
                    ...
                    <div><img src="../img/readymade.jpg"></div>
                    <h2>Readymade</h2>
                    <p>
            ...
            <div class="aside">
                <div class="article">
                    ...
                    <div class="link-article">
                        <ol>
                            <li><a href="fred_skitty.php">La DJ Fred Skitty</a></li>
                            <li><a href="article.php">Up'Date, à ne pas manquer!</a></li>
                        </ol>
                    </div>
                </div>
                <div class="voir">
